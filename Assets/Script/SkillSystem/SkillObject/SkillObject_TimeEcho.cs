...
public class SkillObject_TimeEcho : SkillObject_Base
{
    ...
    [SerializeField] protected float farCheckRadius = 1;
    ...
    public void PerformFarAttack()
    {
        DamageEnemiesInRadius(farTargetCheck, 1);
    }
    ...
    protected override void OnDrawGizmos()
    {
        ...
        if (farTargetCheck == null)
            farTargetCheck = transform;

        Gizmos.color = Color.yellow;
        Gizmos.DrawWireSphere(farTargetCheck.position, farCheckRadius);
    }
}
