...
public class UI_StatSlot : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void UpdateStatValue()
    {
        ...
        {
            Debug.Log($"You dont have {statSlotType} implemented on Player!!!");
            return;
        }
        ...
        switch (statSlotType)
        {
            ...
            case StatType.Strength:
                value = playerStats.attribute.strength.GetValue();
                break;

            case StatType.Agility:
                value = playerStats.attribute.agility.GetValue();
                break;

            case StatType.Intelligence:
                value = playerStats.attribute.intelligence.GetValue();
                break;

            case StatType.Vitality:
                value = playerStats.attribute.vitality.GetValue();
                break;
